function showTime() { 
	...
	var startDate = new Date(2019, 06, 27);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear SXQ:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----Unborn   2019-06-27</c>"; 
